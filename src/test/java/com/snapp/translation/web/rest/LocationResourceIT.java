...
import com.snapp.translation.domain.Location;
import com.snapp.translation.repository.LocationRepository;
import com.snapp.translation.service.dto.LocationDTO;
import com.snapp.translation.service.mapper.LocationMapper;
...
class LocationResourceIT {
    ...
    private static final String DEFAULT_EXACT_ADDRESS = "AAAAAAAAAA";
    private static final String UPDATED_EXACT_ADDRESS = "BBBBBBBBBB";
    ...
    public static Location createEntity(EntityManager em) {
        Location location = new Location().lat(DEFAULT_LAT).lng(DEFAULT_LNG).exactAddress(DEFAULT_EXACT_ADDRESS);
        return location;
    }
    ...
    public static Location createUpdatedEntity(EntityManager em) {
        Location location = new Location().lat(UPDATED_LAT).lng(UPDATED_LNG).exactAddress(UPDATED_EXACT_ADDRESS);
        return location;
    }
    ...
    void createLocation() throws Exception {
        ...
        assertThat(testLocation.getExactAddress()).isEqualTo(DEFAULT_EXACT_ADDRESS);
    }
    ...
    void getAllLocations() throws Exception {
        ...
        restLocationMockMvc
            ...
            .andExpect(jsonPath("$.[*].exactAddress").value(hasItem(DEFAULT_EXACT_ADDRESS)));
    }
    ...
    void getLocation() throws Exception {
        ...
        restLocationMockMvc
            ...
            .andExpect(jsonPath("$.exactAddress").value(DEFAULT_EXACT_ADDRESS));
    }
    ...
    void putNewLocation() throws Exception {
        ...
        updatedLocation.lat(UPDATED_LAT).lng(UPDATED_LNG).exactAddress(UPDATED_EXACT_ADDRESS);
        ...
        assertThat(testLocation.getExactAddress()).isEqualTo(UPDATED_EXACT_ADDRESS);
    }
    ...
    void partialUpdateLocationWithPatch() throws Exception {
        ...
        partialUpdatedLocation.lat(UPDATED_LAT).exactAddress(UPDATED_EXACT_ADDRESS);
    ...
    void fullUpdateLocationWithPatch() throws Exception {
        ...
        partialUpdatedLocation.lat(UPDATED_LAT).lng(UPDATED_LNG).exactAddress(UPDATED_EXACT_ADDRESS);
