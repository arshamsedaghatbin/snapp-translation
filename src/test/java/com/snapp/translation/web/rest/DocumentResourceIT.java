...
class DocumentResourceIT {
    ...
    public static Document createEntity(EntityManager em) {
        Document document = new Document().file(DEFAULT_FILE).fileContentType(DEFAULT_FILE_CONTENT_TYPE).price(DEFAULT_PRICE);
        return document;
    }
    ...
    public static Document createUpdatedEntity(EntityManager em) {
        Document document = new Document().file(UPDATED_FILE).fileContentType(UPDATED_FILE_CONTENT_TYPE).price(UPDATED_PRICE);
        return document;
    }
    ...
    void createDocument() throws Exception {
        ...
        assertThat(testDocument.getPrice()).isEqualByComparingTo(DEFAULT_PRICE);
    }
    ...
    void putNewDocument() throws Exception {
        ...
        updatedDocument.file(UPDATED_FILE).fileContentType(UPDATED_FILE_CONTENT_TYPE).price(UPDATED_PRICE);
    ...
    void partialUpdateDocumentWithPatch() throws Exception {
        ...
        partialUpdatedDocument.price(UPDATED_PRICE);
        ...
        assertThat(testDocument.getFile()).isEqualTo(DEFAULT_FILE);
        assertThat(testDocument.getFileContentType()).isEqualTo(DEFAULT_FILE_CONTENT_TYPE);
        assertThat(testDocument.getPrice()).isEqualByComparingTo(UPDATED_PRICE);
    }
    ...
    void fullUpdateDocumentWithPatch() throws Exception {
        ...
        partialUpdatedDocument.file(UPDATED_FILE).fileContentType(UPDATED_FILE_CONTENT_TYPE).price(UPDATED_PRICE);
