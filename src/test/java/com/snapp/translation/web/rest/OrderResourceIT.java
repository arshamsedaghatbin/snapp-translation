...
class OrderResourceIT {
    ...
    private static final DeliveryType DEFAULT_HAND_OVER_TYPE = DeliveryType.NEED_TO_SEND;
    private static final DeliveryType UPDATED_HAND_OVER_TYPE = DeliveryType.UPLOADE;

    private static final DeliveryType DEFAULT_DELIVERY_TYPE = DeliveryType.NEED_TO_SEND;
    private static final DeliveryType UPDATED_DELIVERY_TYPE = DeliveryType.UPLOADE;
    ...
    public static Order createEntity(EntityManager em) {
        Order order = new Order().handOverType(DEFAULT_HAND_OVER_TYPE).deliveryType(DEFAULT_DELIVERY_TYPE);
        return order;
    }
    ...
    public static Order createUpdatedEntity(EntityManager em) {
        Order order = new Order().handOverType(UPDATED_HAND_OVER_TYPE).deliveryType(UPDATED_DELIVERY_TYPE);
        return order;
    }
    ...
    void createOrder() throws Exception {
        ...
        assertThat(testOrder.getHandOverType()).isEqualTo(DEFAULT_HAND_OVER_TYPE);
    ...
    void putNewOrder() throws Exception {
        ...
        updatedOrder.handOverType(UPDATED_HAND_OVER_TYPE).deliveryType(UPDATED_DELIVERY_TYPE);
        ...
        Order testOrder = orderList.get(orderList.size() - 1);
        assertThat(testOrder.getHandOverType()).isEqualTo(UPDATED_HAND_OVER_TYPE);
    ...
    void fullUpdateOrderWithPatch() throws Exception {
        ...
        partialUpdatedOrder.handOverType(UPDATED_HAND_OVER_TYPE).deliveryType(UPDATED_DELIVERY_TYPE);
