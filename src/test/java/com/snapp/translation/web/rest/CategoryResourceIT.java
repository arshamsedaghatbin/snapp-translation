...
import com.snapp.translation.domain.Category;
import com.snapp.translation.domain.enumeration.CategoryType;
import com.snapp.translation.repository.CategoryRepository;
import com.snapp.translation.service.dto.CategoryDTO;
import com.snapp.translation.service.mapper.CategoryMapper;
...
class CategoryResourceIT {
    ...
    private static final CategoryType DEFAULT_DOCUMENT_CATEGORY = CategoryType.IDENTICAL_DOCUMENT;
    private static final CategoryType UPDATED_DOCUMENT_CATEGORY = CategoryType.EDUCTIONAL_DOCUMENT;
    ...
    public static Category createEntity(EntityManager em) {
        Category category = new Category().documentCategory(DEFAULT_DOCUMENT_CATEGORY);
        return category;
    }
    ...
    public static Category createUpdatedEntity(EntityManager em) {
        Category category = new Category().documentCategory(UPDATED_DOCUMENT_CATEGORY);
        return category;
    }
    ...
    void createCategory() throws Exception {
        ...
        assertThat(testCategory.getDocumentCategory()).isEqualTo(DEFAULT_DOCUMENT_CATEGORY);
    }
    ...
    void putNewCategory() throws Exception {
        ...
        updatedCategory.documentCategory(UPDATED_DOCUMENT_CATEGORY);
        ...
        Category testCategory = categoryList.get(categoryList.size() - 1);
        assertThat(testCategory.getDocumentCategory()).isEqualTo(UPDATED_DOCUMENT_CATEGORY);
    }
    ...
    void fullUpdateCategoryWithPatch() throws Exception {
        ...
        partialUpdatedCategory.documentCategory(UPDATED_DOCUMENT_CATEGORY);
